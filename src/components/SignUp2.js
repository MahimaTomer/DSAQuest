      ...
      <div className="row main">
        <div className="col-6 ">
          <div className="p-4 box">
            ...
            <h2 className="heading1">Sign Up To <span>DSAQuest</span></h2>
            ...
            <Form onSubmit={handleSubmit}>
              <Form.Group className="mb-2" controlId="formBasicUserType">
                ...
                >
                  ...
                  <option value="seller">Graduated</option>
                  <option value="admin">Working Professional</option>
                </Form.Control>
              </Form.Group>
        ...
        <div className="col-6">
          <div className="img-container">
            <img src={signUpImg} class="img-fluid" alt="Sample image"></img>
          </div>
        </div>
      </div>
    </>
